...
export const rinoDiagnosticsV1Schema = {
  ...
  "$defs": {
    ...
    "GraphDiagnosticV1": {
      ...
      "properties": {
        "code": {
          "$ref": "#/$defs/GraphDiagnosticCodeV1"
        },
        "severity": {
          "$ref": "#/$defs/DiagnosticSeverityV1"
        },
        "location": {
          "$ref": "#/$defs/DiagnosticLocationV1"
        },
        "messageKey": {
