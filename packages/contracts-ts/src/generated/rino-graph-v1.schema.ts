...
export const rinoGraphV1Schema = {
  ...
  "$defs": {
    ...
    "WorkflowGroupV1": {
      ...
      "properties": {
        ...
        "members": {
          "type": "array",
          "items": {
            "$ref": "#/$defs/WorkflowGroupMemberV1"
          },
          "minItems": 1,
          "maxItems": 32
        },
    ...
    "GraphV1": {
      ...
      "properties": {
        ...
        "kind": {
          "$ref": "#/$defs/GraphKindV1"
        },
        "functionSignature": {
          "$ref": "#/$defs/FunctionSignatureV1"
        },
        "variables": {
          "type": "array",
          "items": {
        ...
        "editorMetadata": {
          "$ref": "#/$defs/GraphEditorMetadataV1"
        }
      },
      "if": {
        "properties": {
    ...
    "ImageAssetV1": {
      ...
      "properties": {
        ...
        "coordinateSpace": {
          "$ref": "#/$defs/CoordinateSpaceV1"
        },
        "sourceKind": {
          "$ref": "#/$defs/AssetSourceKindV1"
        },
        "createdAt": {
          "type": "string",
          "format": "date-time"
