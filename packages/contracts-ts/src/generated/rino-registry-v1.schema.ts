...
export const rinoRegistryV1Schema = {
  ...
  "$defs": {
    ...
    "NodeDefinitionV1": {
      ...
      "properties": {
        ...
        "runtimeKind": {
          "$ref": "#/$defs/RuntimeKindV1"
        },
        "sideEffect": {
          "$ref": "#/$defs/SideEffectV1"
        },
        "category": {
          "$ref": "#/$defs/NodeCategoryV1"
        },
        "titleKey": {
          "$ref": "#/$defs/LocalizationKeyV1"
        },
        ...
        "requiredCapabilities": {
          "type": "array",
          "items": {
            "$ref": "#/$defs/CapabilityKeyV1"
          },
          "maxItems": 16
        },
        "deprecation": {
          "$ref": "#/$defs/DeprecationV1"
        }
      }
    },
    "TemplateNodeV1": {
    ...
    "TemplateWorkflowGroupV1": {
      ...
      "properties": {
        "kind": {
          "$ref": "#/$defs/WorkflowGroupKindV1"
        },
        "members": {
          "type": "array",
          "items": {
            "$ref": "#/$defs/TemplateWorkflowGroupMemberV1"
          },
          "minItems": 1,
          "maxItems": 32
        },
        "exposedPorts": {
          "type": "array",
          "items": {
            "$ref": "#/$defs/TemplateWorkflowGroupPortV1"
          },
          "maxItems": 32
        }
      }
    ...
    "WorkflowTemplateV1": {
      ...
      "properties": {
        ...
        "workflowGroup": {
          "$ref": "#/$defs/TemplateWorkflowGroupV1"
        }
      }
    }
  }
