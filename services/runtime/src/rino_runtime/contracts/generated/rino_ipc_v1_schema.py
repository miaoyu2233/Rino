  ...
  "$defs": {
    ...
    "ProtocolErrorV1": {
      ...
      "properties": {
        ...
        "retryability": {
          "type": "string",
          "enum": ["never", "safe", "explicitConfirmation"]
        },
        "requestId": { "type": "string", "format": "uuid" },
        "runId": { "type": "string", "format": "uuid" },
        "nodeId": { "type": "string", "format": "uuid" },
        "backendOperationId": { "type": "string", "maxLength": 128 },
        "causes": {
          "type": "array",
          "items": { "$ref": "#/$defs/ErrorCauseEntryV1" },
          "maxItems": 8
        }
      }
    },
    ...
    "HandshakeRequestPayloadV1": {
      ...
      "properties": {
        "desktopVersion": { "$ref": "#/$defs/SemanticVersionV1" },
        "protocolVersionRange": { "$ref": "#/$defs/ProtocolVersionRangeV1" },
        "maximumFrameBytes": {
          "type": "integer",
          "minimum": 4096,
          "maximum": 16777216
    ...
    "MaaRuntimeStateV1": {
      ...
      "properties": {
        ...
        "bindingVersion": { "$ref": "#/$defs/SemanticVersionV1" },
        "nativeVersion": { "$ref": "#/$defs/SemanticVersionV1" }
      }
    },
    "DeviceKeyV1": {
      "title": "DeviceKeyV1",
    ...
    "DeviceStateV1": {
      "title": "DeviceStateV1",
      "type": "string",
      "enum": ["available", "connected", "connectionLost"]
    },
    "DeviceDescriptorV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["deviceKey", "displayName", "controllerFamily", "state"],
      "properties": {
        "deviceKey": { "$ref": "#/$defs/DeviceKeyV1" },
        "displayName": {
          "type": "string",
          "minLength": 1,
          "maxLength": 128
        },
        "controllerFamily": { "type": "string", "enum": ["adb"] },
        "state": { "$ref": "#/$defs/DeviceStateV1" }
      }
    },
    "DeviceListResultV1": {
      ...
      "properties": {
        "devices": {
          "type": "array",
          "items": { "$ref": "#/$defs/DeviceDescriptorV1" },
          "maxItems": 64
        }
      }
    },
    ...
    "DeviceConnectResultV1": {
      ...
      "required": ["device"],
      "properties": {
        "device": { "$ref": "#/$defs/DeviceDescriptorV1" }
      }
    },
    ...
    "DeviceInteractionPointV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["x", "y", "coordinateSpaceId", "sourceGeneration"],
      "properties": {
    ...
    "DeviceClickInteractionV1": {
      ...
      "properties": {
        ...
        "point": { "$ref": "#/$defs/DeviceInteractionPointV1" }
      }
    },
    "DeviceLongPressInteractionV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["kind", "point", "durationMilliseconds"],
      "properties": {
        "kind": { "const": "longPress", "type": "string" },
        "point": { "$ref": "#/$defs/DeviceInteractionPointV1" },
    ...
    "DeviceSwipeInteractionV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["kind", "start", "end", "durationMilliseconds"],
      "properties": {
        "kind": { "const": "swipe", "type": "string" },
        "start": { "$ref": "#/$defs/DeviceInteractionPointV1" },
        "end": { "$ref": "#/$defs/DeviceInteractionPointV1" },
        "durationMilliseconds": {
          "type": "integer",
          "minimum": 50,
          "maximum": 5000
    ...
    "DeviceKeyInteractionV1": {
      ...
      "required": ["kind", "key"],
      "properties": {
        "kind": { "const": "key", "type": "string" },
        "key": { "const": "back", "type": "string" }
      }
    },
    "DeviceInteractionV1": {
    ...
    "DeviceInteractRequestPayloadV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["deviceKey", "interaction"],
      "properties": {
        "deviceKey": { "$ref": "#/$defs/DeviceKeyV1" },
        "interaction": { "$ref": "#/$defs/DeviceInteractionV1" }
      }
    },
    "DeviceInteractResultV1": {
      ...
      "properties": {
        ...
        "kind": {
          "type": "string",
          "enum": ["click", "longPress", "swipe", "key"]
        }
      }
    },
    "PreviewTokenV1": {
    ...
    "PreviewCaptureRequestPayloadV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["deviceKey", "maximumWidth", "maximumHeight"],
      "properties": {
        "deviceKey": { "$ref": "#/$defs/DeviceKeyV1" },
        "maximumWidth": {
          "type": "integer",
    ...
    "PreviewArtifactDescriptorV1": {
      ...
      "properties": {
        "previewToken": { "$ref": "#/$defs/PreviewTokenV1" },
        "mediaType": { "const": "image/png", "type": "string" },
    ...
    "PreviewCaptureResultV1": {
      ...
      "required": ["preview"],
      "properties": {
        "preview": { "$ref": "#/$defs/PreviewArtifactDescriptorV1" }
      }
    },
    ...
    "CapturePrepareRequestPayloadV1": {
      ...
      "properties": {
        "previewToken": { "$ref": "#/$defs/PreviewTokenV1" },
        "region": { "$ref": "#/$defs/CaptureRegionV1" }
      }
    },
    "CaptureArtifactDescriptorV1": {
      ...
      "properties": {
        "captureToken": { "$ref": "#/$defs/CaptureTokenV1" },
        "mediaType": { "const": "image/png", "type": "string" },
        "width": { "type": "integer", "minimum": 1, "maximum": 16384 },
        "height": { "type": "integer", "minimum": 1, "maximum": 16384 },
        "coordinateSpaceId": {
        ...
        "sourceKind": {
          "type": "string",
          "enum": ["deviceCapture", "regionCapture"]
        },
        "byteLength": {
          "type": "integer",
          "minimum": 1,
    ...
    "CapturePrepareResultV1": {
      ...
      "required": ["capture"],
      "properties": {
        "capture": { "$ref": "#/$defs/CaptureArtifactDescriptorV1" }
      }
    },
    ...
    "HandshakeResultV1": {
      ...
      "properties": {
        "runtimeVersion": { "$ref": "#/$defs/SemanticVersionV1" },
        ...
        "runtimeMode": { "type": "string", "enum": ["source", "frozen"] },
        ...
        "maaRuntime": { "$ref": "#/$defs/MaaRuntimeStateV1" },
        "featureFlags": {
          "type": "array",
    ...
    "HealthResultV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["state", "uptimeMilliseconds"],
      "properties": {
    ...
    "GraphValidateResultV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["executable", "report"],
      "properties": {
        "executable": { "type": "boolean" },
        "report": { "$ref": "#/$defs/JsonObject" }
      }
    },
    ...
    "PersistentBoolVariableV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["variableId", "valueKind", "value"],
      "properties": {
        "variableId": { "type": "string", "format": "uuid" },
        "valueKind": { "const": "bool", "type": "string" },
        "value": { "type": "boolean" }
      }
    },
    "PersistentNumberVariableV1": {
      ...
      "properties": {
        "variableId": { "type": "string", "format": "uuid" },
        "valueKind": { "const": "number", "type": "string" },
        "value": { "type": "number", "minimum": -1e308, "maximum": 1e308 }
      }
    },
    "PersistentStringVariableV1": {
      ...
      "properties": {
        "variableId": { "type": "string", "format": "uuid" },
        "valueKind": { "const": "string", "type": "string" },
    ...
    "PersistentPointVariableV1": {
      ...
      "properties": {
        "variableId": { "type": "string", "format": "uuid" },
        "valueKind": { "const": "point", "type": "string" },
        "value": { "$ref": "#/$defs/PersistentPointValueV1" }
      }
    },
    "PersistentRectVariableV1": {
      ...
      "properties": {
        "variableId": { "type": "string", "format": "uuid" },
        "valueKind": { "const": "rect", "type": "string" },
        "value": { "$ref": "#/$defs/PersistentRectValueV1" }
      }
    },
    ...
    "RunStartRequestPayloadV1": {
      ...
      "properties": {
        ...
        "assetBindings": {
          ...
          "type": "array",
          "items": { "$ref": "#/$defs/RunProjectAssetBindingV1" },
          "maxItems": 32
        },
        "deviceKey": {
          "type": "string",
        ...
        "initialPersistentVariables": {
          "type": "array",
          "items": { "$ref": "#/$defs/PersistentVariableValueV1" },
          "maxItems": 128
        }
      }
    },
    "RunStartResultV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["accepted", "runId", "graphId", "registryVersion"],
      "properties": {
        "accepted": { "const": true, "type": "boolean" },
        "runId": { "type": "string", "format": "uuid" },
        "graphId": { "type": "string", "format": "uuid" },
    ...
    "RunCancelResultV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["accepted", "runId", "alreadyRequested", "state"],
      "properties": {
        "accepted": { "const": true, "type": "boolean" },
        "runId": { "type": "string", "format": "uuid" },
        ...
        "state": {
          "type": "string",
          "enum": ["cancelling", "succeeded", "failed", "cancelled"]
        }
      }
    },
    "RuntimeValueSummaryV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["portId", "generation", "kind", "preview", "truncated"],
      "properties": {
        ...
        "preview": { "type": "string", "maxLength": 256 },
    ...
    "RunStateChangedEventPayloadV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["state", "graphId"],
      "properties": {
        "state": {
          "type": "string",
          "enum": ["running", "cancelling", "succeeded", "failed", "cancelled"]
        },
        "graphId": { "type": "string", "format": "uuid" },
        "runSequence": {
          "type": "integer",
        ...
        "terminalError": { "$ref": "#/$defs/RuntimeTerminalErrorV1" },
    ...
    "NodeStateChangedEventPayloadV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["state", "runSequence", "tokenId", "activationId"],
      "properties": {
        "state": {
          "type": "string",
        ...
        "valueSummaries": {
          "type": "array",
          "items": { "$ref": "#/$defs/RuntimeValueSummaryV1" },
          "maxItems": 64
        },
        "errorCode": {
          "type": "string",
    ...
    "EdgeTraversedEventPayloadV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["edgeId", "runSequence", "tokenId", "outputPortId"],
      "properties": {
        ...
        "outputPortId": { "type": "string", "minLength": 1, "maxLength": 64 }
      }
    },
    "RuntimeLogCreatedEventPayloadV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["logSequence", "activationId", "level", "message"],
      "properties": {
        "logSequence": {
          "type": "integer",
          "minimum": 1,
    ...
    "AutomationOperationStateChangedEventPayloadV1": {
      ...
      "properties": {
        "source": { "type": "string", "enum": ["controller", "tasker"] },
        "state": {
          "type": "string",
          "enum": ["starting", "succeeded", "failed"]
        },
        "operationKind": {
          "type": "string",
          "enum": [
    ...
    "AutomationCallbackDiagnosticEventPayloadV1": {
      ...
      "type": "object",
      "additionalProperties": false,
      "required": ["code", "count", "backendGeneration"],
      "properties": {
        "code": {
          "type": "string",
          "enum": [
    ...
    "DeviceStateChangedEventPayloadV1": {
      ...
      "properties": {
        ...
        "reason": {
          "type": "string",
          "enum": ["connected", "disconnected", "connectionLost"]
        }
      }
    },
    ...
    "SystemProtocolErrorEventPayloadV1": {
      ...
      "required": ["error"],
      "properties": {
        "error": { "$ref": "#/$defs/ProtocolErrorV1" }
      }
    },
    "RequestEnvelopeV1": {
      ...
      "properties": {
        "protocolVersion": { "const": 1, "type": "integer" },
        "messageKind": { "const": "request", "type": "string" },
        "messageType": {
          "type": "string",
          "pattern": "^[a-z][a-zA-Z0-9]*(?:\\.[a-z][a-zA-Z0-9]*)+$",
          "maxLength": 128
    ...
    "SuccessResponseEnvelopeV1": {
      ...
      "properties": {
        "protocolVersion": { "const": 1, "type": "integer" },
        "messageKind": { "const": "response", "type": "string" },
        "messageType": {
          "type": "string",
          "pattern": "^[a-z][a-zA-Z0-9]*(?:\\.[a-z][a-zA-Z0-9]*)+$",
          "maxLength": 128
    ...
    "EventEnvelopeV1": {
      ...
      "properties": {
        "protocolVersion": { "const": 1, "type": "integer" },
        "messageKind": { "const": "event", "type": "string" },
        "messageType": {
          "type": "string",
          "pattern": "^[a-z][a-zA-Z0-9]*(?:\\.[a-z][a-zA-Z0-9]*)+$",
          "maxLength": 128
...
RINO_IPC_V1_SCHEMA: Final[dict[str, Any]] = cast(
